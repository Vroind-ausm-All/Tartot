...
namespace Tartot.Core
{
    ...
    public static class ProphecyCatalog
    {
        ...
        public static readonly List<ProphecyDefinition> All = new List<ProphecyDefinition>
        {
            ...
            P("welt_oeffnet", "Die Welt öffnet sich", "Lege insgesamt 50-mal DIE WELT.", 50,
            ...
            P("ueberschuss", "Überschuss", "Triff 250 über das Leben eines Gegners hinaus.", 250,
                Best("bestOverkill"), "", "predator_fang"),
            P("kettenleser", "Kettenleser", "Halte eine Musterkette über 7 Züge.", 7,
            ...
            P("schwarzer_spiegel", "Schwarzer Spiegel", "Besitze zwei schwarze Karten zugleich.", 2,
                Best("mostBlackCards"), "", "twin_coin"),
            P("weg_ist_ziel", "Der Weg ist das Ziel", "Erlebe insgesamt 20 Ereignisse.", 20,
